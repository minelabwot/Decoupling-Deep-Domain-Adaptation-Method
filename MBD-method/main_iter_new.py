...
if __name__ == '__main__':
    ...
    # 对训练数据的读入路径进行配置
    src_train_feature = "dataimba/MBDtraindata_{}.npy".format(args.src_motor)
    src_train_label = "dataimba/MBDtrainlabel_{}.npy".format(args.src_motor)
    tar_train_feature = "dataimba/MBDtraindata_{}.npy".format(args.tar_motor)
    tar_train_label = "dataimba/MBDtrainlabel_{}.npy".format(args.tar_motor)
    src_valid_feature = ""
    src_valid_label = ""
    tar_valid_feature = ""
    tar_valid_label = ""
    src_test_feature = "dataimba/MBDtestdata_{}.npy".format(args.src_motor)
    src_test_label = "dataimba/MBDtestlabel_{}.npy".format(args.src_motor)
    tar_test_feature = "dataimba/MBDtestdata_{}.npy".format(args.tar_motor)
    tar_test_label = "dataimba/MBDtestlabel_{}.npy".format(args.tar_motor)
